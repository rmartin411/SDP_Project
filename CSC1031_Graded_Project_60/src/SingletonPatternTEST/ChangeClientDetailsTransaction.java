...
public class ChangeClientDetailsTransaction extends TransactionTemplate {
	...
	public BankClient clientLoggedIn;
	...
	public void changeClientDetails(BankClient clientLoggedIn) throws ParseException {
		...
		this.password2 = clientLoggedIn.password;
	...
	public void provideDetails(BankClient clientLoggedIn) {
	...
	*/
	 ...
	 /*
	public void executeTransaction(BankClient clientLoggedIn) throws ParseException {
	...
	*/
	...
	public void executeTransaction() {
		try {
			this.clientLoggedIn.changeCientDetails(name, address, new SimpleDateFormat("dd/MM/yyyy").parse(DoBStr), username, password);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		
		this.clientLoggedIn.print();
	}
}
